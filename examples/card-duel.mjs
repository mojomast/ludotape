...
export const game=defineGame({id:'ludotape/card-duel',version:'1.0.0',metadata:{title:'Seeded Card Duel'},
 ...
 actions(s){return s.round>=5?[]:s.hand.map((value,index)=>({type:'play',index,value}))},
 ...
 isGoal(s){return s.round===5&&s.score>0}, project(s){return {kind:'cards',hand:s.hand,score:s.score,round:s.round,last:s.last}}
});
